...
public:
    ...
    bool check_user_permiss(std::string &db_user, std::string &query);
    bool backup_sql(std::string &query, std::string &db_user);
    bool restore_sql(std::string &port, std::string &db_name, std::string &host_name, std::string &db_user);
