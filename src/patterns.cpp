...
bool SQLPatterns::CompilePatterns()
{
    ...
    // if (compile_pattern(grant_str, &grant_re, &grant_pe) == false){
    //     free();
	// return false;
    // }
    // if (compile_pattern(revoke_str, &revoke_re, &revoke_pe) == false)
    // {
    //     free();
	// return false;
    // }
...
bool SQLPatterns::Match(MatchType type, const std::string & str)
{
	...
	case SQL_EMPTY_PWD:
	{
        ...
        case SQL_BRUTEFORCE_FUNCTIONS:
        {
            if (bruteforce_functions_str.length() == 0)
                return false;
            rc = pcre_exec(bruteforce_functions_re, bruteforce_functions_pe, str.c_str(), len,
                           0, 0, NULL, 0);
            break;
        }
        // case SQL_GRANT:
        ...
        //     if(grant_str.length() == 0)
        //         return false;
        //     rc = pcre_exec(grant_re, grant_pe, str.c_str(), len , 0, 0, NULL, 0);
        //     break;
        // }
        // case SQL_REVOKE:
        // {
        //     if(revoke_str.length() == 0)
        //         return false;
        //     rc = pcre_exec(revoke_re, revoke_pe, str.c_str(), len , 0, 0, NULL, 0);
        //     break;
        // }
